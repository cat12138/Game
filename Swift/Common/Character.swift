...
class Character {
    ...
    init() {
        ...
        // 1 - MARK: Load character from external file
        ...
        // 2 - MARK: Configure collision capsule
        ...
        /* [Shark]
         * kinematic: affect others, like hero
         * dynamic: affected, like box
         * static: unaffected, like floor
         */
    ...
    private var previousUpdateTime = TimeInterval(0.0) //for delta
